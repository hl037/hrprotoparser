...
//# if tsize:
typedef {{ {'1': 'uint8_t', '2': 'uint18_t', '4':'uint32_t', '8':'uint64_t' }[_p.proto.F['FIXEDTSIZE'].val] }} {{_p.prefix}}hrp_ptype_t;
//# -
//# else:
...
typedef {{ {'1': 'uint8_t', '2': 'uint18_t', '4':'uint32_t', '8':'uint64_t' }[_p.proto.F['FIXEDSIZE'].val] }} {{_p.prefix}}hrp_stype_t;
//# -
//# else:
